...
from LAVIS.lavis.datasets.datasets.aok_vqa_datasets import AOKVQADataset, AOKVQAEvalDataset, AOKVQAInstructDataset
from LAVIS.lavis.datasets.datasets.coco_vqa_datasets import COCOVQADataset, COCOVQAEvalDataset, COCOVQAInstructDataset
from LAVIS.lavis.datasets.datasets.vg_vqa_datasets import VGVQADataset, VGVQAInstructDataset
from LAVIS.lavis.datasets.datasets.gqa_datasets import GQADataset, GQAEvalDataset, GQAInstructDataset
from LAVIS.lavis.datasets.datasets.iconqa_datasets import IconQADataset, IconQAEvalDataset, IconQAInstructDataset
from LAVIS.lavis.datasets.datasets.ocr_datasets import OCRVQADataset, OCRVQAInstructDataset
from LAVIS.lavis.datasets.datasets.vizwiz_vqa_datasets import VizWizEvalDataset
