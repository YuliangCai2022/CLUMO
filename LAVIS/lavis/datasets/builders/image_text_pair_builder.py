...
from LAVIS.lavis.datasets.datasets.image_text_pair_datasets import ImageTextPairDataset, ImageTextPairInstructDataset
from LAVIS.lavis.datasets.datasets.laion_dataset import LaionDataset, LaionInstructDataset
