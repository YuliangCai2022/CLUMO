...
from LAVIS.lavis.datasets.builders.object3d_caption_builder import ObjaverseCaptionBuilder
from LAVIS.lavis.datasets.datasets.object3d_qa_datasets import ObjaverseQADataset
