...
from LAVIS.lavis.datasets.datasets.video_vqa_datasets import VideoQADataset, VideoQAInstructDataset
from LAVIS.lavis.datasets.datasets.music_avqa import MusicAVQAInstructDataset, MusicAVQADataset
